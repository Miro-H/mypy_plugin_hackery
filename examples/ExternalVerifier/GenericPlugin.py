...
from CustomConstraints import _Constraints
...
VECTOR_TYPE_NAME : Final = "FancyVectorType.Vector"

class HecoPlugin(Plugin):
    def get_type_analyze_hook(self, fullname: str):
        print("len", len(_Constraints().constraints))
        for fn, cb in _Constraints():
            print("registered", fn, cb)
            if fullname == fn:
                return cb
